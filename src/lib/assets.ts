...
export const images = {
  // Home page images
  home: {
    hero: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=1920&q=80",
  },
  ...
  events: {
    ...
    privateParty:
      "https://images.unsplash.com/photo-1470753937643-efeb931202a9?w=1200&q=80",
  },
...
export function getImagePath(
  ...
  return (
    images[category]?.[image as keyof (typeof images)[typeof category]] || ""
  );
}
